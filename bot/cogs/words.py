...
class Words(commands.Cog):
    ...
    @commands.command(
        name="trackword",
        aliases=["tw"],
        help="Track how many times a word has been used",
    )
    ...
    @commands.has_guild_permissions(manage_messages=True)
    @commands.command(
        name="untrackword", aliases=["utw"], help="Untrack a word"
    )
    ...
    @commands.command(
        name="viewwordcount",
        aliases=["vwc"],
        help="View how many times a word has been said",
    )
    ...
    @commands.command(
        name="viewtrackedwords",
        aliases=["vtw"],
        help="View all the words being tracked",
    )
